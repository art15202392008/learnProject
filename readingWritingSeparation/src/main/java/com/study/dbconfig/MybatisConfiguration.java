package com.study.dbconfig;

import com.github.pagehelper.PageHelper;
import com.study.util.SpringContextUtil;
...
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactorys() throws Exception {
       ...
       //     sessionFactoryBean.setDataSource(roundRobinDataSouce);
            ...
            // 读取配置 
            sessionFactoryBean.setTypeAliasesPackage("com.study.domain");
            ...
            //添加分页插件、打印sql插件
            Interceptor[] plugins = new Interceptor[]{pageHelper(),new com.study.dbconfig.SqlPrintInterceptor()};
    ...
    public AbstractRoutingDataSource roundRobinDataSouceProxy() {
        ...
        //否则切换数据源时找不到正确的数据源
        targetDataSources.put(com.study.dbconfig.DataSourceType.write.getType(), writeDataSource);
        targetDataSources.put(com.study.dbconfig.DataSourceType.read.getType()+"1", readDataSource01);
        targetDataSources.put(com.study.dbconfig.DataSourceType.read.getType()+"2", readDataSource02);
   ...
   //     MyAbstractRoutingDataSource proxy = new MyAbstractRoutingDataSource(readSize);
        ...
        AbstractRoutingDataSource proxy = new AbstractRoutingDataSource(){
        	...
        	protected Object determineCurrentLookupKey() {
        		String typeKey = com.study.dbconfig.DataSourceContextHolder.getReadOrWrite();
                ...
                if (typeKey.equals(com.study.dbconfig.DataSourceType.write.getType())){
                	System.err.println("使用数据库write.............");
                    return com.study.dbconfig.DataSourceType.write.getType();
                }
                ...
                return com.study.dbconfig.DataSourceType.read.getType()+(lookupKey+1);
        	}
        };
